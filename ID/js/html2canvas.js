...
(function (global, factory) {
    ...
    Trie.prototype.get = function (codePoint) {
      ...
      if (codePoint >= 0) {
        ...
        if (codePoint <= 0xffff) {
          ...
          ix =
            this.index[UTRIE2_LSCP_INDEX_2_OFFSET$1 + ((codePoint - 0xd800) >> UTRIE2_SHIFT_2$1)];
          ix = (ix << UTRIE2_INDEX_SHIFT$1) + (codePoint & UTRIE2_DATA_MASK$1);
          return this.data[ix];
        }
  ...
  var isEndingTokenFor = function (token, type) {
    ...
    return (
      type === 2 /* LEFT_PARENTHESIS_TOKEN */ && token.type === 3 /* RIGHT_PARENTHESIS_TOKEN */
    );
  };
    ...
    ElementPaint.prototype.getEffects = function (target) {
      ...
      while (parent) {
        ...
        if (inFlow || parent.container.styles.position !== 0 /* STATIC */ || !parent.parent) {
          ...
          inFlow =
            [2 /* ABSOLUTE */, 3 /* FIXED */].indexOf(parent.container.styles.position) === -1;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              border = borders_1[_i];
              if (
                !(border.style !== 0 /* NONE */ && !isTransparent(border.color) && border.width > 0)
              )
                return [3 /*break*/, 11];
